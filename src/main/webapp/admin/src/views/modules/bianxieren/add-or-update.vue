  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="编写人姓名" prop="bianxierenxingming">
              <el-input v-model="ruleForm.bianxierenxingming" 
                placeholder="编写人姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="编写人性别" prop="bianxierenxingbie">
          <el-select v-model="ruleForm.bianxierenxingbie" placeholder="请选择编写人性别">
            <el-option
                v-for="(item,index) in bianxierenxingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="编写人性别" prop="bianxierenxingbie">
	      <el-input v-model="ruleForm.bianxierenxingbie"
                placeholder="编写人性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
            ...
            ruleForm: {
                	        bianxierenzhanghao: '',
	                        	        ...
	                        	        touxiang: '',
                                                                  ...
                                                                  bianxierenxingbieOptions: [],
                                                                            rules: {
                  bianxierenzhanghao: [
                            { required: true, message: '编写人账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bianxierenxingming = true;
            continue;
	            	            ...
	            	            if(o=='bianxierenxingbie'){
            this.ruleForm.bianxierenxingbie = obj[o];
	    this.ro.bianxierenxingbie = true;
            continue;
          }
	            	            if(o=='lianxifangshi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `bianxieren/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bianxierenCrossAddOrUpdateFlag = false;
                  this.parent.search();
