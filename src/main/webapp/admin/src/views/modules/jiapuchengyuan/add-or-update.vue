<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="编写人账号" prop="bianxierenzhanghao">
          <el-input v-model="ruleForm.bianxierenzhanghao" 
              placeholder="编写人账号" clearable  :readonly="ro.bianxierenzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="编写人账号" prop="bianxierenzhanghao">
              <el-input v-model="ruleForm.bianxierenzhanghao" 
                placeholder="编写人账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="编写人姓名" prop="bianxierenxingming">
          <el-input v-model="ruleForm.bianxierenxingming" 
              placeholder="编写人姓名" clearable  :readonly="ro.bianxierenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="编写人姓名" prop="bianxierenxingming">
              <el-input v-model="ruleForm.bianxierenxingming" 
                placeholder="编写人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="世代" prop="shidai">
          <el-input v-model="ruleForm.shidai" 
              placeholder="世代" clearable  :readonly="ro.shidai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="世代" prop="shidai">
              <el-input v-model="ruleForm.shidai" 
                placeholder="世代" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="排行" prop="paixing">
          <el-input v-model="ruleForm.paixing" 
              placeholder="排行" clearable  :readonly="ro.paixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="排行" prop="paixing">
              <el-input v-model="ruleForm.paixing" 
                placeholder="排行" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出承" prop="chucheng">
          <el-input v-model="ruleForm.chucheng" 
              placeholder="出承" clearable  :readonly="ro.chucheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出承" prop="chucheng">
              <el-input v-model="ruleForm.chucheng" 
                placeholder="出承" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.hunyinzhuangkuang"
                placeholder="婚姻状况" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配偶" prop="peiou">
          <el-input v-model="ruleForm.peiou" 
              placeholder="配偶" clearable  :readonly="ro.peiou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配偶" prop="peiou">
              <el-input v-model="ruleForm.peiou" 
                placeholder="配偶" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="子女信息" prop="zinvxinxi">
          <el-input v-model="ruleForm.zinvxinxi" 
              placeholder="子女信息" clearable  :readonly="ro.zinvxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="子女信息" prop="zinvxinxi">
              <el-input v-model="ruleForm.zinvxinxi" 
                placeholder="子女信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人事迹" prop="gerenshiji">
          <el-input v-model="ruleForm.gerenshiji" 
              placeholder="个人事迹" clearable  :readonly="ro.gerenshiji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人事迹" prop="gerenshiji">
              <el-input v-model="ruleForm.gerenshiji" 
                placeholder="个人事迹" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	bianxierenzhanghao : false,
	bianxierenxingming : false,
	zhanghao : false,
	xingming : false,
	xingbie : false,
	shouji : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='bianxierenzhanghao'){
            this.ruleForm.bianxierenzhanghao = obj[o];
	    this.ro.bianxierenzhanghao = true;
            continue;
          }
	            	            if(o=='bianxierenxingming'){
            this.ruleForm.bianxierenxingming = obj[o];
	    this.ro.bianxierenxingming = true;
            continue;
          }
	            	            if(o=='zhanghao'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='shidai'){
            this.ruleForm.shidai = obj[o];
	    this.ro.shidai = true;
            continue;
          }
	            	            if(o=='paixing'){
            this.ruleForm.paixing = obj[o];
	    this.ro.paixing = true;
            continue;
          }
	            	            if(o=='chucheng'){
            this.ruleForm.chucheng = obj[o];
	    this.ro.chucheng = true;
            continue;
          }
	            	            if(o=='chushengriqi'){
	    ...
	    this.ro.hunyinzhuangkuang = true;
            continue;
	            	            ...
	            	            if(o=='peiou'){
            this.ruleForm.peiou = obj[o];
	    this.ro.peiou = true;
            continue;
          }
	            	            if(o=='zinvxinxi'){
            this.ruleForm.zinvxinxi = obj[o];
	    this.ro.zinvxinxi = true;
            continue;
          }
	            	            if(o=='gerenshiji'){
            this.ruleForm.gerenshiji = obj[o];
	    this.ro.gerenshiji = true;
            continue;
          }
	                    }
                                                                                                                                                                                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiapuchengyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiapuchengyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
