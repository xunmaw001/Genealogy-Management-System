  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">家谱管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
																																	...
																																	<!-- <div v-if="tableName=='bianxieren'" class="input-group">
			   <div class="label">编写人账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.bianxierenzhanghao" class="input" type="text" placeholder="编写人账号">
			   </div>
			 </div> -->
			<el-form-item label="编写人账号" class="input" v-if="tableName=='bianxieren'">
			  <el-input v-model="ruleForm.bianxierenzhanghao" autocomplete="off" placeholder="编写人账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='bianxieren'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='bianxieren'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='bianxieren'" class="input-group">
			   <div class="label">编写人姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.bianxierenxingming" class="input" type="text" placeholder="编写人姓名">
			   </div>
			 </div> -->
			<el-form-item label="编写人姓名" class="input" v-if="tableName=='bianxieren'">
			  <el-input v-model="ruleForm.bianxierenxingming" autocomplete="off" placeholder="编写人姓名" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='bianxieren'" class="input-group">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='bianxieren'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='bianxieren'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='bianxieren'" class="input-group">
			   <div class="label">身份证</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='bianxieren'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                            ...
                                                                                                            if((!this.ruleForm.bianxierenzhanghao) && `bianxieren` == this.tableName){
        this.$message.error(`编写人账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `bianxieren` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                      if(`bianxieren` == this.tableName && this.ruleForm.lianxifangshi&&(!this.$validate.isMobile(this.ruleForm.lianxifangshi))){
        this.$message.error(`联系方式应输入手机格式`);
        return
      }
                                                                        if(`bianxieren` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
                                                                        if(`bianxieren` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
                                                                                                                  this.$http({
